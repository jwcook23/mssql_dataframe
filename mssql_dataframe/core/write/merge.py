...
class merge(insert):
    ...
    upsert: bool = False, delete_conditions: list = None,
    include_timestamps: bool = True):
        ...
        # perform merge
        if delete_conditions is None:
            args = [table_name, temp_name]+match_columns+update_columns+insert_columns
        else:
            args = [table_name, temp_name]+match_columns+update_columns+insert_columns+delete_conditions
